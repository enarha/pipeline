...
// ConfigMapName returns the name of the ConfigMap that contains metrics configuration.
func ConfigMapName() string {
	return "config-observability"
}

// Record is a placeholder function for recording metrics
func Record(ctx context.Context, measurement interface{}) {
